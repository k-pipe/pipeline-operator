...
func (in *InputPipe) DeepCopyInto(out *InputPipe) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new InputPipe.
func (in *InputPipe) DeepCopy() *InputPipe {
	if in == nil {
		return nil
	}
	out := new(InputPipe)
...
func (in *PipelineDefinitionSpec) DeepCopyInto(out *PipelineDefinitionSpec) {
	*out = *in
	...
	if in.TerminationJobs != nil {
		in, out := &in.TerminationJobs, &out.TerminationJobs
